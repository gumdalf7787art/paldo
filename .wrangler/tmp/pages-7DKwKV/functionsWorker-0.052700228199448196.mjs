...
// ../.wrangler/tmp/bundle-79t265/strip-cf-connecting-ip-header.js
...
__name(createResponse2, "createResponse");
...
__name(createResponse3, "createResponse");
...
__name(createResponse4, "createResponse");
...
__name(createResponse5, "createResponse");
...
__name(getAuthenticatedUser5, "getAuthenticatedUser");
...
__name(createResponse6, "createResponse");
...
__name(getAuthenticatedUser6, "getAuthenticatedUser");
...
__name(createResponse7, "createResponse");
...
__name(verifyToken8, "verifyToken");
...
__name(getAuthenticatedUser7, "getAuthenticatedUser");
...
__name(createResponse8, "createResponse");
...
async function onRequestGet6(context) {
  ...
  if (id) {
    try {
      ...
      if (dog.images) {
        try {
          dog.images = JSON.parse(dog.images);
        } catch (e) {
          dog.images = dog.images.split(",").filter(Boolean);
        }
      } else {
        dog.images = [];
      }
      return createResponse8(dog);
    } catch (err) {
...
async function onRequestPost8(context) {
  ...
  const { breed, nickname, price, gender, age, vaccine, neutered, description, images } = body;
  if (!breed || !nickname) {
  ...
  try {
    ...
    const result = await env.DB.prepare(
      "INSERT INTO dogs (breed, nickname, price, gender, age, vaccine, neutered, description, images, status, seller_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
    ).bind(
      breed,
      nickname,
      price || 0,
...
__name(verifyToken9, "verifyToken");
...
__name(getAuthenticatedUser8, "getAuthenticatedUser");
...
__name(createResponse9, "createResponse");
...
async function onRequestGet7(context) {
  ...
  if (!authUser) {
    return createResponse9({ error: "\uB85C\uADF8\uC778\uC774 \uD544\uC694\uD55C \uC791\uC5C5\uC785\uB2C8\uB2E4." }, 401);
  }
  try {
    const { results } = await env.DB.prepare(
      "SELECT id, user_id, type, message, is_read, created_at FROM notifications WHERE user_id = ? ORDER BY created_at DESC"
    ).bind(authUser.id).all();
    return createResponse9(results);
  } catch (err) {
    return createResponse9({ error: `\uC54C\uB9BC \uC870\uD68C \uC2E4\uD328: ${err.message}` }, 500);
  }
}
...
async function onRequestPost9(context) {
  ...
  if (action === "read_all") {
    try {
      ...
      return createResponse9({ success: true, message: "\uBAA8\uB4E0 \uC54C\uB9BC\uC744 \uC77D\uC74C \uCC98\uB9AC\uD588\uC2B5\uB2C8\uB2E4." });
    } catch (err) {
      return createResponse9({ error: `\uC54C\uB9BC \uC77D\uC74C \uCC98\uB9AC \uC2E4\uD328: ${err.message}` }, 500);
    }
  }
  const { user_id, type, message } = body;
  if (!user_id || !message) {
    return createResponse9({ error: "\uB300\uC0C1 \uC720\uC800 ID\uC640 \uC54C\uB9BC \uBA54\uC2DC\uC9C0\uB294 \uD544\uC218\uC785\uB2C8\uB2E4." }, 400);
  }
  try {
    ...
    return createResponse9({ success: true, message: "\uC54C\uB9BC\uC774 \uC131\uACF5\uC801\uC73C\uB85C \uB4F1\uB85D\uB418\uC5C8\uC2B5\uB2C8\uB2E4." });
  } catch (err) {
    return createResponse9({ error: `\uC54C\uB9BC \uB4F1\uB85D \uC2E4\uD328: ${err.message}` }, 500);
  }
}
...
__name(verifyToken10, "verifyToken");
...
__name(getAuthenticatedUser9, "getAuthenticatedUser");
...
__name(createResponse10, "createResponse");
...
async function onRequestPost10(context) {
  ...
  if (!target_id || !type) {
    return createResponse10({ error: "\uC2E0\uACE0 \uB300\uC0C1 \uB9E4\uBB3C ID\uC640 \uC2E0\uACE0 \uC0AC\uC720 \uC720\uD615\uC740 \uD544\uC218\uC785\uB2C8\uB2E4." }, 400);
  }
  try {
    await env.DB.prepare(
      "INSERT INTO reports (user_id, target_id, type, reason) VALUES (?, ?, ?, ?)"
    ).bind(authUser.id, target_id, type, reason || "").run();
    return createResponse10({ success: true, message: "\uC2E0\uACE0\uAC00 \uC815\uC0C1\uC801\uC73C\uB85C \uC811\uC218\uB418\uC5C8\uC2B5\uB2C8\uB2E4. \uC6B4\uC601\uC9C4\uC774 \uAC80\uD1A0\uD560 \uC608\uC815\uC785\uB2C8\uB2E4." });
  } catch (err) {
    return createResponse10({ error: `\uC2E0\uACE0 \uC811\uC218 \uC2E4\uD328: ${err.message}` }, 500);
  }
}
...
__name(verifyToken11, "verifyToken");
...
__name(getAuthenticatedUser10, "getAuthenticatedUser");
...
__name(createResponse11, "createResponse");
...
async function onRequestGet8(context) {
  ...
  if (!sellerId) {
    return createResponse11({ error: "\uD310\uB9E4\uC790 ID\uB294 \uD544\uC218\uC785\uB2C8\uB2E4." }, 400);
  }
  if (action === "reviews") {
    try {
      ...
      return createResponse11(reviews);
    } catch (err) {
      return createResponse11({ error: `\uB9AC\uBDF0 \uBAA9\uB85D \uC870\uD68C \uC2E4\uD328: ${err.message}` }, 500);
    }
  }
  try {
    ...
    if (!profile) {
      return createResponse11({ error: "\uC0C1\uC810\uC744 \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4." }, 404);
    }
    ...
    return createResponse11({
      profile,
      biz: biz || null
    });
  } catch (err) {
    return createResponse11({ error: `\uC0C1\uC810 \uC815\uBCF4 \uC870\uD68C \uC2E4\uD328: ${err.message}` }, 500);
  }
}
...
async function onRequestPost11(context) {
  ...
  if (action === "create_review") {
    ...
    if (!seller_id || rating === void 0) {
      return createResponse11({ error: "\uD310\uB9E4\uC790 ID\uC640 \uD3C9\uC810\uC740 \uD544\uC218 \uC785\uB825 \uC0AC\uD56D\uC785\uB2C8\uB2E4." }, 400);
    }
    try {
      if (seller_id === authUser.id) {
        return createResponse11({ error: "\uC790\uC2E0\uC758 \uC0C1\uC810\uC5D0\uB294 \uB9AC\uBDF0\uB97C \uC791\uC131\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4." }, 400);
      }
      await env.DB.prepare(
        "INSERT INTO store_reviews (seller_id, reviewer_id, rating, content) VALUES (?, ?, ?, ?)"
      ).bind(seller_id, authUser.id, rating, content || "").run();
      return createResponse11({ success: true, message: "\uB9AC\uBDF0\uAC00 \uC815\uC0C1\uC801\uC73C\uB85C \uB4F1\uB85D\uB418\uC5C8\uC2B5\uB2C8\uB2E4." });
    } catch (err) {
      return createResponse11({ error: `\uB9AC\uBDF0 \uB4F1\uB85D \uC2E4\uD328: ${err.message}` }, 500);
    }
  }
  return createResponse11({ error: "\uC9C0\uC6D0\uD558\uC9C0 \uC54A\uB294 \uC694\uCCAD \uC561\uC158\uC785\uB2C8\uB2E4." }, 400);
}
__name(onRequestPost11, "onRequestPost");

// ../.wrangler/tmp/pages-7DKwKV/functionsRoutes-0.1060852371468125.mjs
var routes = [
  {
    routePath: "/api/admin",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-79t265/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-79t265/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.052700228199448196.mjs.map
