    ...
    <div className="container fade-in" style={{ padding: '40px 20px', minHeight: '80vh' }}>
      ...
      <div style={{
        ...
        <ul style={{ margin: 0, paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <li><strong>서비스 제공 기간: 결제 완료 후 즉시 이용 가능</strong> (본 서비스는 무형의 소프트웨어(SaaS) 솔루션으로, 결제 완료 즉시 멤버십 이용권이 계정에 지급되어 실시간으로 사용 가능합니다.)</li>
                ...
                <button 
                  ...
                  onClick={async () => {
                    ...
                    const paymentData = {
                      ...
                      pg: payMethod === 'tosspay' ? 'tosspay' : 'html5_inicis',
