          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div>
              ...
              <p style={{ margin: 0, fontSize: '0.9rem', color: '#666', lineHeight: '1.6' }}>
                본 약관은 주식회사 블루프라임(이하 '회사')이 운영하는 반려견 안심 분양 매칭 플랫폼 '다잇독(DAITDOG)'(이하 '플랫폼')에서 제공하는 사업자용 유료 서비스(광고 및 멤버십 구독) 결제 및 환불에 관한 조건과 절차를 규정함을 목적으로 합니다.
              </p>
            </div>

            <div>
              <h3 style={{ fontSize: '1.1rem', fontWeight: 'bold', color: '#333', marginBottom: '8px' }}>제2조 (광고 및 정기 구독 서비스의 정의)</h3>
              <ul style={{ paddingLeft: '20px', margin: 0, fontSize: '0.9rem', color: '#666', lineHeight: '1.6', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <li><strong>[유료 광고 서비스]</strong> 입점 매장(사업자)은 플랫폼 내 분양 노출 효과를 높이기 위해 회사가 제공하는 다양한 형태의 유료 광고 아이템을 건별 또는 기간제로 구매하여 사용할 수 있습니다.</li>
                <li><strong>[정기 구독 서비스]</strong> 회사는 입점 매장의 마케팅과 플랫폼 기능(게시글 등록 한도 증대 등)을 지원하기 위해 등급별 월 정기 구독 멤버십을 운영합니다. 본 서비스는 매월 자동으로 결제가 갱신되는 정기 결제 상품입니다.</li>
              </ul>
            </div>
