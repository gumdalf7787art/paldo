      ...
      <div className="glass-card" style={{ 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              ...
              {isTermsOpen && (
                <div className="fade-in" style={{ 
                  ...
                  <strong>[다잇독 서비스 이용약관]</strong><br/><br/>
                  제1조 (목적)<br/>
                  본 약관은 다잇독 플랫폼이 제공하는 모든 서비스의 이용 조건 및 절차에 관한 권리와 의무를 규정함을 목적으로 합니다.<br/><br/>
                  제2조 (회원의 의무)<br/>
                  ...
                  제3조 (책임의 한계)<br/>
                  다잇독은 회원 간의 원활한 정보 공유 및 소통을 지원하는 시스템 제공자로서 회원 간의 직접적인 교류 과정에서 발생하는 사고나 분쟁에 대해 책임을 지지 않습니다. 거래 전 상대방의 정보를 확인하세요.<br/><br/>
                  제4조 (개인정보 보호)<br/>
        ...
        <div style={{ marginTop: '40px', textAlign: 'center' }}>
          <p style={{ fontSize: '0.8rem', color: '#ccc' }}>
            가장 따뜻한 가족을 만나는 첫 걸음을 다잇독과 함께하세요.
          </p>
        </div>
      </div>
    </div>
