  ...
  const plans = [
    {
      ...
      name: '베이직',
      price: 30000,
      description: '소규모 사업장을 위한 기본 관리 플랜',
      features: ['기본 스토어 프로필 제공 (일반 검색 노출)', '기본 테마 관리 툴 제공', '이메일 지원 서비스'],
      color: '#4A90E2'
    },
    {
      id: 'pro',
      name: '프로',
      price: 50000,
      description: '가장 많은 파트너사가 선택하는 플랜',
      features: ['프리미엄 스토어 페이지 (상단 우선 노출)', '프로페셔널 전용 테마 제공', '실시간 방문 분석 통계 대시보드', '1:1 채널 톡 상담원 연동'],
      color: 'var(--primary)',
      isPopular: true
    },
    {
      ...
      name: '프로페셔널',
      price: 100000,
      description: '대형 매장 및 프랜차이즈를 위한 VIP 플랜',
      features: ['VIP 브랜드 스토어 구축 (메인 배너 노출)', '프리미엄 ERP 매장 관리 시스템', '정밀 스토어 데이터 보고서 제공', '전담 기술 마스터 배정', '스토어 전용 도메인 연결 지원'],
      color: '#9b59b6'
    }
  ];
